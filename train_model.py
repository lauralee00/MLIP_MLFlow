...
# Set experiment name
email="yeheunl@andrew.cmu.edu" # TODO: Use a customized experiment name
...
trained_model = pipeline.train_logistic_regression(X_train=X_train, y_train=y_train, params=params)
# TODO: use `pipeline.evaluation` to evaluate the model
accuracy= pipeline.evaluation(model=trained_model, X_test=X_test, y_test=y_test)

# Log model and metrics to tracking serverhost
# Start an MLflow run
run_name="Run 1" # You can specify a run name or let MLFlow choose one for you.
